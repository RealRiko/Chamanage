<section>
    ...
    <form method="post" action="<?php echo e(route('password.update')); ?>" class="mt-6 space-y-6">
        ...
        <div>
            <label class="form-label" for="update_password_current_password"><?php echo e(__('Current Password')); ?></label>
            <input
...
<?php endif; ?>
        ...
        <div>
            <label class="form-label" for="update_password_password"><?php echo e(__('New Password')); ?></label>
            <input
...
<?php endif; ?>
        ...
        <div>
            <label class="form-label" for="update_password_password_confirmation"><?php echo e(__('Confirm Password')); ?></label>
            <input
...
<?php /**PATH /home5/deveralv/chamanage.lat/CRM-main/resources/views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>