<?php $__env->startSection('title', __('form.product.create_title') . ' — ' . config('app.name')); ?>
...
<div class="edit-page">
    <div style="max-width: 740px; margin: 0 auto; padding: 40px 24px 64px;">
        ...
        <nav class="breadcrumb" aria-label="breadcrumb">
            ...
            <span><?php echo e(__('form.product.create_title')); ?></span>
        </nav>
        ...
        <header style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:28px; flex-wrap:wrap;">
            <div>
                ...
                <h1 class="ep-title" style="margin-top:8px;"><?php echo e(__('form.product.create_title')); ?></h1>
                <p class="ep-subtitle" style="margin-top:6px;"><?php echo e(__('form.product.create_sub')); ?></p>
            </div>
        ...
        <div class="form-panel">
            ...
            <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    <?php echo $__env->make('products._product_fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div class="form-footer">
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <button type="submit" class="btn-save">
                            ...
                            <?php echo e(__('form.product.submit_create')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home5/deveralv/chamanage.lat/CRM-main/resources/views/products/create.blade.php ENDPATH**/ ?>