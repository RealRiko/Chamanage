<?php $__env->startSection('title', __('form.client.edit_title') . ' — ' . config('app.name')); ?>
...
<div class="edit-page">
    <div style="max-width: 740px; margin: 0 auto; padding: 40px 24px 64px;">
        ...
        <nav class="breadcrumb" aria-label="breadcrumb">
            ...
            <span style="max-width: 160px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($client->name); ?></span>
            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="opacity:.4;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            <span><?php echo e(__('form.client.edit_title')); ?></span>
        </nav>
        ...
        <header style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:28px; flex-wrap:wrap;">
            <div>
                ...
                <h1 class="ep-title" style="margin-top:8px;"><?php echo e(__('form.client.edit_title')); ?></h1>
                <p class="ep-subtitle" style="margin-top:6px;"><?php echo e(__('form.client.edit_sub')); ?></p>
            </div>
        ...
        <div class="form-panel">
            ...
            <form action="<?php echo e(route('clients.update', $client)); ?>" method="POST">
                ...
                <div class="form-body">
                    ...
                    <?php endif; ?>
                    <?php echo $__env->make('clients._client_fields', ['client' => $client], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div class="form-footer">
                    <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                        ...
                        <?php if($client->updated_at): ?>
                            <span style="font-size:12px; color:#a8a29e;"><?php echo e($client->updated_at->diffForHumans()); ?></span>
                        <?php endif; ?>
                    </div>
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <button type="submit" class="btn-save">
                            ...
                            <?php echo e(__('form.client.submit_update')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home5/deveralv/chamanage.lat/CRM-main/resources/views/clients/edit.blade.php ENDPATH**/ ?>