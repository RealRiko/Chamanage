<?php $__env->startSection('title', __('form.product.edit_title') . ' — ' . config('app.name')); ?>
...
<div class="edit-page">
    <div style="max-width: 740px; margin: 0 auto; padding: 40px 24px 64px;">
        ...
        <nav class="breadcrumb" aria-label="breadcrumb">
            <a href="<?php echo e(route('products.index')); ?>"><?php echo e(__('page.products.badge')); ?></a>
            ...
            <span style="max-width: 160px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($product->name); ?></span>
            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="opacity:.4;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            <span><?php echo e(__('form.product.edit_title')); ?></span>
        </nav>
        ...
        <header style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:28px; flex-wrap:wrap;">
            <div>
                <span class="ep-eyebrow"><?php echo e(__('page.products.badge')); ?></span>
                <h1 class="ep-title" style="margin-top:8px;"><?php echo e(__('form.product.edit_title')); ?></h1>
                <p class="ep-subtitle" style="margin-top:6px;"><?php echo e(__('form.product.edit_sub')); ?></p>
            </div>
        ...
        <div class="form-panel">
            ...
            <form action="<?php echo e(route('products.update', $product)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <?php if($errors->any()): ?>
                    <div class="form-errors-slot">
                        <div class="error-banner" role="alert">
                            ...
                            <div>
                                <strong style="display:block; margin-bottom:4px;"><?php echo e(__('form.errors_found', 'Lūdzu labojiet kļūdas')); ?></strong>
                ...
                <div class="form-body">
                    <?php echo $__env->make('products._product_fields', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div class="form-footer">
                    <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                        ...
                        <?php if($product->updated_at): ?>
                            <span style="font-size:12px; color:#a8a29e;"><?php echo e($product->updated_at->diffForHumans()); ?></span>
                        <?php endif; ?>
                    </div>
                    <div style="display:flex; align-items:center; gap:10px;">
                        <a href="<?php echo e(route('products.index')); ?>" class="btn-back"><?php echo e(__('form.back')); ?></a>
                        <button type="submit" class="btn-save">
                            ...
                            <?php echo e(__('form.product.submit_update')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home5/deveralv/chamanage.lat/CRM-main/resources/views/products/edit.blade.php ENDPATH**/ ?>