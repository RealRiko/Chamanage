<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full scroll-smooth transition-colors duration-300">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo e(config('app.name', 'Chamanage')); ?> — <?php echo e(__('welcome.title_suffix')); ?></title>
...
<body class="mesh min-h-screen text-zinc-900 antialiased overflow-x-hidden dark:text-white">
    ...
    <header class="sticky top-0 z-50 border-b border-zinc-200/90 bg-white/85 backdrop-blur-xl dark:border-white/[0.08] dark:bg-zinc-950/80">
        <div class="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-3">
                ...
                <span class="font-display text-lg font-bold tracking-tight text-zinc-900 dark:text-white"><?php echo e(config('app.name', 'Chamanage')); ?></span>
            </a>
            <div class="flex flex-wrap items-center justify-end gap-2 sm:gap-2.5">
                <div class="inline-flex shrink-0 rounded-lg border border-zinc-200/80 bg-zinc-50 p-0.5 dark:border-white/10 dark:bg-white/5">
                ...
                <button type="button" id="welcome-theme-toggle"
                        ...
                        title="<?php echo e(__('theme.light')); ?> / <?php echo e(__('theme.dark')); ?>">
                ...
                <a href="<?php echo e(route('login')); ?>" class="rounded-xl px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 dark:text-white/85 dark:hover:bg-white/10 sm:px-4">
                    <?php echo e(__('welcome.nav_login')); ?>

                </a>
                <a href="<?php echo e(route('register')); ?>"
                   class="rounded-xl bg-brand px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-brand/30 transition hover:bg-brand-dark hover:shadow-brand/40 sm:px-5 sm:py-2.5">
                    <?php echo e(__('welcome.nav_register')); ?>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-16 xl:gap-20">
                <div class="animate-fade-up opacity-0 [animation-fill-mode:forwards]">
                    <p class="mb-4 inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white/90 px-4 py-1.5 font-display text-[11px] font-semibold uppercase tracking-[0.2em] text-amber-800 dark:border-white/10 dark:bg-white/[0.06] dark:text-amber-200/95">
                        <?php echo e(__('welcome.hero_kicker')); ?>
                    ...
                    <h1 class="font-display text-4xl font-extrabold leading-[1.08] tracking-tight text-zinc-900 sm:text-5xl xl:text-6xl dark:text-white">
                        <?php echo e(__('welcome.hero_line1')); ?>

                        <span class="bg-gradient-to-r from-amber-700 via-brand to-amber-600 bg-clip-text text-transparent dark:from-amber-100 dark:via-brand dark:to-amber-300"><?php echo e(__('welcome.hero_gradient')); ?></span>
                    </h1>
                    <p class="mt-6 max-w-lg text-base leading-relaxed text-zinc-600 sm:text-lg dark:text-white/60">
                        <?php echo e(__('welcome.hero_sub')); ?>
                    ...
                    <div class="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
                        <a href="<?php echo e(route('register')); ?>"
                           class="inline-flex items-center justify-center rounded-2xl bg-brand px-8 py-4 font-display text-[15px] font-bold text-white shadow-xl shadow-brand/35 transition hover:bg-brand-dark hover:shadow-brand/45">
                            <?php echo e(__('welcome.cta_create')); ?>
                        ...
                        <a href="<?php echo e(route('login')); ?>"
                           class="inline-flex items-center justify-center rounded-2xl border border-zinc-200 bg-white px-8 py-4 font-medium text-zinc-800 transition hover:border-zinc-300 hover:bg-zinc-50 dark:border-white/15 dark:bg-white/[0.04] dark:text-white/90 dark:hover:border-white/25 dark:hover:bg-white/[0.08]">
                            <?php echo e(__('welcome.cta_have_account')); ?>

                        </a>
                    </div>
                    <dl class="mt-12 grid grid-cols-3 gap-4 border-t border-zinc-200 pt-10 dark:border-white/10 sm:max-w-md">
                        <div>
                            <dt class="text-[11px] font-medium uppercase tracking-wider text-zinc-500 dark:text-white/40"><?php echo e(__('welcome.stat_modules')); ?></dt>
                            <dd class="font-display mt-1 text-2xl font-bold text-zinc-900 dark:text-white">6+</dd>
                        </div>
                        <div>
                            <dt class="text-[11px] font-medium uppercase tracking-wider text-zinc-500 dark:text-white/40"><?php echo e(__('welcome.stat_pdf')); ?></dt>
                            <dd class="font-display mt-1 text-2xl font-bold text-zinc-900 dark:text-white"><?php echo e(__('welcome.stat_yes')); ?></dd>
                        </div>
                        <div>
                            <dt class="text-[11px] font-medium uppercase tracking-wider text-zinc-500 dark:text-white/40"><?php echo e(__('welcome.stat_roles')); ?></dt>
                    ...
                    <div class="relative ring-glow rounded-3xl p-[1px]">
                        <div class="overflow-hidden rounded-[22px] glass">
                            <div class="flex items-center gap-2 border-b border-zinc-200 px-4 py-3 dark:border-white/10">
                                ...
                                <span class="ml-2 text-[11px] text-zinc-400 dark:text-white/35"><?php echo e(__('welcome.preview_label')); ?></span>
                            </div>
                            <div class="p-5 sm:p-6">
                                <div class="mb-6 flex items-end justify-between gap-4">
                                    <div>
                                        <p class="text-xs text-zinc-500 dark:text-white/40"><?php echo e(__('welcome.preview_income')); ?></p>
                                ...
                                <div class="mb-6 flex h-24 items-end justify-between gap-1.5 rounded-xl bg-zinc-100 px-3 pb-2 pt-4 dark:bg-white/[0.04]">
                                    <?php $__currentLoopData = [40, 65, 45, 80, 55, 90, 70, 85, 60, 95, 75, 88]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="w-full rounded-sm bg-gradient-to-t from-brand/80 to-amber-400/50" style="height: <?php echo e($h); ?>%"></div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <div class="space-y-2">
                                    <?php $__currentLoopData = [__('welcome.demo_row1'), __('welcome.demo_row2'), __('welcome.demo_row3')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <section id="features" class="border-t border-zinc-200 bg-zinc-100/90 py-20 dark:border-white/[0.07] dark:bg-black/30">
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2 class="font-display text-3xl font-extrabold tracking-tight text-zinc-900 sm:text-4xl dark:text-white"><?php echo e(__('welcome.bento_heading')); ?></h2>
                    <p class="mt-3 text-zinc-600 dark:text-white/50"><?php echo e(__('welcome.bento_sub')); ?></p>
                </div>
                ...
                <div class="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 lg:gap-5">
                    <article class="bento-hover glass-card group relative overflow-hidden rounded-3xl p-7 sm:col-span-2 lg:row-span-1">
                        ...
                        <div class="relative">
                            <span class="inline-flex rounded-lg border border-zinc-200 bg-white/80 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-amber-800 dark:border-white/10 dark:bg-white/[0.06] dark:text-amber-200/90"><?php echo e(__('welcome.card_team_kicker')); ?></span>
                            <h3 class="font-display mt-4 text-xl font-bold text-zinc-900 sm:text-2xl dark:text-white"><?php echo e(__('welcome.card_team_title')); ?></h3>
                            <p class="mt-3 max-w-xl text-sm leading-relaxed text-zinc-600 dark:text-white/55">
                                <?php echo e(__('welcome.card_team_text')); ?>
                    ...
                    <article class="bento-hover glass-card rounded-3xl p-7">
                        ...
                        <h3 class="font-display mt-4 text-lg font-bold text-zinc-900 dark:text-white"><?php echo e(__('welcome.card_docs_title')); ?></h3>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-white/50"><?php echo e(__('welcome.card_docs_text')); ?></p>
                    </article>
                    ...
                    <article class="bento-hover glass-card rounded-3xl p-7">
                        ...
                        <h3 class="font-display mt-4 text-lg font-bold text-zinc-900 dark:text-white"><?php echo e(__('welcome.card_reports_title')); ?></h3>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-white/50"><?php echo e(__('welcome.card_reports_text')); ?></p>
                    </article>

                    <article class="bento-hover glass-card rounded-3xl p-7 sm:col-span-2 lg:col-span-2">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <h3 class="font-display text-lg font-bold text-zinc-900 dark:text-white"><?php echo e(__('welcome.card_stock_title')); ?></h3>
                                <p class="mt-2 text-sm text-zinc-600 dark:text-white/50"><?php echo e(__('welcome.card_stock_text')); ?></p>
                            </div>
                            <div class="group shrink-0 inline-flex max-w-[15rem] items-center gap-3 rounded-2xl border border-amber-400/35 bg-gradient-to-br from-amber-100/90 to-white px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)] ring-1 ring-zinc-200/80 transition hover:border-amber-500/50 sm:max-w-[17rem] dark:border-amber-400/20 dark:from-amber-500/[0.12] dark:to-white/[0.03] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] dark:ring-white/5 dark:hover:border-amber-400/35 dark:hover:from-amber-500/[0.18]">
                                ...
                                <p class="text-left text-[13px] font-semibold leading-snug text-zinc-800 sm:text-sm dark:text-white/90"><?php echo e(__('welcome.card_stock_callout')); ?></p>
                            </div>
                        </div>
                    </article>
                </div>
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="relative overflow-hidden rounded-[28px] border border-zinc-200 bg-gradient-to-br from-white via-zinc-50 to-zinc-100 px-8 py-14 shadow-2xl sm:px-12 dark:border-white/10 dark:from-zinc-900 dark:via-zinc-950 dark:to-black">
                    ...
                    <div class="relative mx-auto max-w-2xl text-center">
                        <h2 class="font-display text-2xl font-extrabold text-zinc-900 sm:text-3xl dark:text-white"><?php echo e(__('welcome.cta2_title')); ?></h2>
                        <p class="mt-3 text-sm text-zinc-600 sm:text-base dark:text-white/55"><?php echo e(__('welcome.cta2_sub')); ?></p>
                        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex w-full justify-center rounded-2xl bg-brand px-8 py-3.5 font-display font-bold text-white shadow-lg shadow-brand/30 transition hover:bg-brand-dark sm:w-auto">
                                <?php echo e(__('welcome.cta2_register')); ?>

                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex w-full justify-center rounded-2xl border border-zinc-200 bg-white px-8 py-3.5 font-semibold text-zinc-800 transition hover:bg-zinc-50 sm:w-auto dark:border-white/15 dark:bg-white/[0.05] dark:text-white dark:hover:bg-white/10">
                                <?php echo e(__('welcome.cta2_login')); ?>
    ...
    <footer class="border-t border-zinc-200 py-10 text-center text-xs text-zinc-500 dark:border-white/[0.08] dark:text-white/35">
        <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Chamanage')); ?></p>
    </footer>
...
<?php /**PATH /home5/deveralv/chamanage.lat/CRM-main/resources/views/welcome.blade.php ENDPATH**/ ?>